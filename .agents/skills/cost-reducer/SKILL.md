...
> For **AI/LLM token costs and context window efficiency** (model routing, progressive disclosure, compaction), use the `optimizing-tokens` skill instead — this skill covers cloud, infrastructure, and code-level costs only.
