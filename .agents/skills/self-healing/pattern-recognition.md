...
| Workflow sequence | 2+ times | 1-2 steps | Memory or AGENTS.md |
...
- "Is AGENTS.md missing any stable conventions?"
...
- Putting stable rules in memory instead of AGENTS.md (memory is for learnings)
