...
├── communication-style.md ← How they want Antigravity to interact
└── corrections.md         ← Mistakes Antigravity made — never repeat these
```
...
- **Date:** 2026-03-10
- **Wrong assumption:** Antigravity added JSDoc comments to existing functions while editing nearby code
...
4. Delete anything that's now in AGENTS.md (no duplication)
...
| Duplicate info that's in AGENTS.md | Reference AGENTS.md, don't copy it |
