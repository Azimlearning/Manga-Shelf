...
Track every time the user corrects Antigravity to prevent repeat mistakes:

### Format
```markdown
### Correction: [What was wrong]
- **Date:** [When]
- **Wrong assumption:** [What Antigravity did/said]
...
- Repeatedly reformatting code Antigravity writes
